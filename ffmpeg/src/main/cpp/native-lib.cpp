...
Java_com_zck_ffmpeg_SpherePlayer_00024Demuxer_createDemuxer(JNIEnv *, jobject ) noexcept {
    return (jlong)(new ffmpeg::Demuxer());
}

extern "C" JNIEXPORT void JNICALL
Java_com_zck_ffmpeg_SpherePlayer_00024Demuxer_destroyDemuxer(JNIEnv *, jobject , jlong pointer) noexcept {
    const auto demuxer = (ffmpeg::Demuxer*)pointer;
    if(demuxer) delete demuxer;
}

extern "C" JNIEXPORT jint JNICALL
Java_com_zck_ffmpeg_SpherePlayer_00024Demuxer_openInput(JNIEnv *env, jobject obj, jlong pointer, jstring url, jobject callback) noexcept {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_zck_ffmpeg_SpherePlayer_00024Demuxer_flush(JNIEnv *, jobject , jlong pointer) noexcept {
    const auto demuxer = (ffmpeg::Demuxer*)pointer;
    return demuxer->flush();
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_zck_ffmpeg_SpherePlayer_00024Demuxer_getErrorString(JNIEnv *env, jobject , jint value) noexcept {
